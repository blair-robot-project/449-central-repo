...
class MappedSparkMaxExternalEncoder @JsonCreator constructor(
    ...
    fwdSoftLimit: Double?,
    revSoftLimit: Double?,
    encoderDIO1: MappedDigitalInput?,
    encoderDIO2: MappedDigitalInput?,
     ...
     */
    private val postEncoderGearing: Double
    ...
    private val spark: CANSparkMax

    /** WPI provided encoder object  */
    @get:JvmName("getEncoder$")
    var encoder: Encoder
    ...
    private var lastTimeUpdate: Double = 0.0
    ...
    override fun setGear(gear: Int) {
        ...
        pidController.p = currentGearSettings.kP
        pidController.i = currentGearSettings.kI
        pidController.d = currentGearSettings.kD
    }
    ...
    override fun configureLogName(): String = name
    ...
    init {
        ...
        encoder = if (encoderDIO1 != null && encoderDIO2 != null) {
            Encoder(encoderDIO1, encoderDIO2, reverseSensor, CounterBase.EncodingType.k4X)
        } else {
            Encoder(0, 1)
        }
        ...
        if (revLimitSwitchNormallyOpen != null) {
            if (remoteLimitSwitchID != null) {
                reverseLimitSwitch = CANSparkMax(remoteLimitSwitchID, CANSparkMaxLowLevel.MotorType.kBrushless)
