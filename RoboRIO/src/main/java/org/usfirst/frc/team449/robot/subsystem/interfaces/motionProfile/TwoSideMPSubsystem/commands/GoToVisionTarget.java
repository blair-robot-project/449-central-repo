...
public class GoToVisionTarget<T extends Subsystem & SubsystemMPTwoSides & SubsystemAHRS>
  ...
  @Nullable private Waypoint[] waypoints;
  /**
   * Getter for the points for the path to hit. Must not be null if the Waypoint[] parameter is
   * null, otherwise is ignored.
   */
  @Nullable private Supplier<Waypoint[]> waypointSupplier;
   ...
   * @param pathRequester The object for interacting with the Jetson. // * @param poseEstimator The
   *     object to get robot pose from.
  ...
  public GoToVisionTarget(
      ...
      //                            @NotNull @JsonProperty(required = true) PoseEstimator
      // poseEstimator,
    ...
    GetPathFromJetson getPath =
        new GetPathFromJetson(pathRequester, null, deltaTime, maxVel, maxAccel, maxJerk, false);
