...
/**
 * A ConditionalCommand that chooses which command to run based off of if the switch is on the left
 * or the right.
 */
...
public class ConditionalCommandSwitchBased extends ConditionalCommand {
   ...
   * @param rightSwitch The Command to execute if the right side of the switch is our alliance
   *     color.
   */
  @JsonCreator
  public ConditionalCommandSwitchBased(@NotNull Command leftSwitch, @NotNull Command rightSwitch) {
