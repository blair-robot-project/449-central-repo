...
/**
 * TODO check this. The class originally had sequential and parallel commands, so I just made it a
 * parallel command group and had a local variable that was a SequentialCommandGroup. Not sure if
 * it'll work The autonomous routine to deliver a gear to the center gear.
 */
...
public class Auto2017Boiler extends ParallelCommandGroup {
   ...
   * @param runRedPegToKeyProfile The command for moving from the peg to the key, on the red side of
   *     the field.
   * @param runBluePegToKeyProfile The command for moving from the peg to the key, on the blue side
   *     of the field.
