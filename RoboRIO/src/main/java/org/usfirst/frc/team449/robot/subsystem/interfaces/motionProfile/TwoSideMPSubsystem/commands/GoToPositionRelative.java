...
public class GoToPositionRelative<T extends Subsystem & SubsystemMPTwoSides>
   ...
   */
  @JsonCreator
  public GoToPositionRelative(
      @NotNull @JsonProperty(required = true) GetPathFromJetson getPath,
      @NotNull @JsonProperty(required = true) T subsystem) {
    this.getPath = getPath;
    addCommands(
        this.getPath, new RunProfileTwoSides<>(subsystem, this::getLeft, this::getRight, 10));
  }
  ...
  /**
   * @return The motion profile for the left side to run, or null if not received from the Jetson
   *     yet.
   */
  @Nullable
  ...
  /**
   * @return The motion profile for the right side to run, or null if not received from the Jetson
   *     yet.
   */
  @Nullable
