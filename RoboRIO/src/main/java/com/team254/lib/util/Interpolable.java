...
public interface Interpolable<T> {
     ...
     * return this value. If x is 1, the method should return the other value. If 0 is less than x is less than 1, the
     * return value should be interpolated proportionally between the two.
     *
