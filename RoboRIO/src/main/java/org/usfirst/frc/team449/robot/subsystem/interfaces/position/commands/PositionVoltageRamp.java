...
public class PositionVoltageRamp<T extends Subsystem & SubsystemPosition> extends CommandBase {
  ...
  public void initialize() {
    Shuffleboard.addEventMarker(
        "PositionVoltageRamp init.", this.getClass().getSimpleName(), EventImportance.kNormal);
  ...
  public void end(boolean interrupted) {
    if (interrupted) {
      Shuffleboard.addEventMarker(
          "PositionVoltageRamp Interrupted!",
          this.getClass().getSimpleName(),
          EventImportance.kNormal);
    }
    subsystem.disableMotor();
    Shuffleboard.addEventMarker(
        "PositionVoltageRamp end.", this.getClass().getSimpleName(), EventImportance.kNormal);
