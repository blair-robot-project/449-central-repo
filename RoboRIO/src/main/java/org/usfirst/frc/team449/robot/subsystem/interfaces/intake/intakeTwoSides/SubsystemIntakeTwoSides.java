...
public interface SubsystemIntakeTwoSides extends SubsystemIntake {
  ...
  void setLeftMode(@NotNull SubsystemIntake.IntakeMode mode);

  /** @param mode The mode to switch the right side of the intake to. */
  void setRightMode(@NotNull SubsystemIntake.IntakeMode mode);

  /** @param mode The mode to switch the intake to. */
  @Override
  default void setMode(@NotNull SubsystemIntake.IntakeMode mode) {
    setLeftMode(mode);
    setRightMode(mode);
  }
}
