...
/**
 * A component for calculating feedforwards for a Talon. Takes the setpoint and returns the correct
 * feedforward voltage.
 */
@JsonTypeInfo(
...
public abstract class FeedForwardComponent implements DoubleUnaryOperator {
  ...
  /**
   * Set the talon to get information from. This is a setter instead of being in the constructor to
   ...
   */
  public abstract double calcMPVoltage(
      double positionSetpoint, double velSetpoint, double accelSetpoint);
