...
#Time, Left X, Left Y, Right X, Right Y, Angle
drawProfile(plotProfile("FLToLoadRevLess", leftInverted = TRUE, rightInverted = TRUE, startPos = c(0, 184./12. + centerToBack, 27.5/12 - centerToSide+wheelbaseDiameter/2., 184./12. + centerToBack, 27.5/12. - centerToSide-wheelbaseDiameter/2., 0), wheelbaseDiameter=wheelbaseDiameter, centerToBack=centerToBack), wheelbaseDiameter=wheelbaseDiameter, centerToBack=centerToBack)