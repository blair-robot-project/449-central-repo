...
public class SubsystemPositionOnboardMP
    implements Subsystem, SubsystemPosition, Updatable, SubsystemMP {
   ...
   */
  @JsonCreator
  public SubsystemPositionOnboardMP(
      @NotNull @JsonProperty(required = true) FPSTalon talon,
  ...
  public void setPositionSetpoint(double feet) {
    disableMotor();
    loadMotionProfile(
        pathGenerator.generateProfile(talon.getPositionFeet(), talon.getVelocity(), accel, feet));
