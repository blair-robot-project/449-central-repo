...
public class LogEvent {
   ...
   * Default constructor.
   *
   * <p>Note to future people: Don't rewrite this to get the calling class from the stack trace.
   * It's possible, and makes the code cleaner than taking the calling class as an argument, but
   * getting the stack trace actually takes Java a little while, and considering how often this
   * constructor is called, that would significantly slow us down.
   *
