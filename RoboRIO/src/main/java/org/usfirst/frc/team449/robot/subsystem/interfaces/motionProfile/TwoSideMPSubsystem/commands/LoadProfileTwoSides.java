...
public class LoadProfileTwoSides<T extends Subsystem & SubsystemMPTwoSides> extends InstantCommand {
  ...
  @NotNull private final SubsystemMPTwoSides subsystem;

  /** The motion profiles for the left and right sides to execute, respectively. */
  @Nullable private final MotionProfileData left, right;

  /** Suppliers for motion profiles for the left and right sides to execute, respectively. */
  @Nullable private final Supplier<MotionProfileData> leftSupplier, rightSupplier;
   ...
   */
  public LoadProfileTwoSides(
      @NotNull SubsystemMPTwoSides subsystem,
