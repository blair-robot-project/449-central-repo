...
public class MotionState {
   ...
   * @return A MotionState that is a valid predecessor (if t is less than or equal to 0) or
   *     successor (if t is greater than or equal to 0) of this state.
   */
   ...
   * @return A MotionState that is a valid predecessor (if t is less than or equal to 0) or
   *     successor (if t is greater than or equal to 0) of this state (with the specified accel).
   */
  ...
  /**
   * Find the next time (first time greater than MotionState.t()) that this MotionState will be at
   * pos. This is an inverse of the extrapolate() method.
   *
