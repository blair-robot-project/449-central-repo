...
class FeedForwardZeroComponent extends FeedForwardComponent {
  ...
  /**
   * Default constructor. Not public and not annotated with @JsonCreator because it should only be
   * constructed via {@link FeedForwardComponent}'s getZeroFeedForward().
   */
